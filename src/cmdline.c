...
const char *gengetopt_args_info_usage = "Usage: peeves [OPTION]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "      --header=STRING    Message header text",
  "      --in-addr=STRING   Input address",
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->in_addr_arg = NULL;
  args_info->in_addr_orig = NULL;
  args_info->in_port_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->header_help = gengetopt_args_info_help[2] ;
  args_info->in_addr_help = gengetopt_args_info_help[3] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->in_addr_arg));
  free_string_field (&(args_info->in_addr_orig));
  free_string_field (&(args_info->in_port_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->in_addr_given)
    write_into_file(outfile, "in-addr", args_info->in_addr_orig, 0);
  if (args_info->in_port_given)
    write_into_file(outfile, "in-port", args_info->in_port_orig, 0);
  if (args_info->out_addr_given)
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->header_given)
    {
      fprintf (stderr, "%s: '--header' option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  
  if (! args_info->in_addr_given)
    {
      fprintf (stderr, "%s: '--in-addr' option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  
  if (! args_info->in_port_given)
    {
      fprintf (stderr, "%s: '--in-port' option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  
  if (! args_info->out_addr_given)
    {
      fprintf (stderr, "%s: '--out-addr' option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  
  if (! args_info->out_port_given)
    {
      fprintf (stderr, "%s: '--out-port' option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          ...
          /* Input address.  */
          else if (strcmp (long_options[option_index].name, "in-addr") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->in_addr_arg), 
                 &(args_info->in_addr_orig), &(args_info->in_addr_given),
                &(local_args_info.in_addr_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "in-addr", '-',
                additional_error))
              goto failure;
          ...
          /* Input port number.  */
          else if (strcmp (long_options[option_index].name, "in-port") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->in_port_arg), 
                 &(args_info->in_port_orig), &(args_info->in_port_given),
                &(local_args_info.in_port_given), optarg, 0, 0, ARG_INT,
                check_ambiguity, override, 0, 0,
                "in-port", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "out-addr") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->out_addr_arg), 
                 &(args_info->out_addr_orig), &(args_info->out_addr_given),
                &(local_args_info.out_addr_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "out-addr", '-',
                additional_error))
              goto failure;
          ...
          /* Output port number.  */
          else if (strcmp (long_options[option_index].name, "out-port") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->out_port_arg), 
                 &(args_info->out_port_orig), &(args_info->out_port_given),
                &(local_args_info.out_port_given), optarg, 0, 0, ARG_INT,
                check_ambiguity, override, 0, 0,
                "out-port", '-',
                additional_error))
              goto failure;
